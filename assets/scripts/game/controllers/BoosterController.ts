...
class SwapBooster implements IBooster {
    ...
    constructor(private readonly board: BoardController, id: string) {
        this.id = id;
    }
...
class SuperBooster implements IBooster {
    ...
    constructor(private readonly board: BoardController, id: string, private readonly superTileId: number) {
        this.id = id;
    }
