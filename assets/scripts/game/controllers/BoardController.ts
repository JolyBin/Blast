...
export class BoardController {
  ...
  private activeteOtherSuperTiles(
    activeTiles: CellPos[],
    currentTile: CellPos,
  ) {
    ...
    activeTiles.forEach((cellPos) => {
      ...
      if (
        !(this.tiles[cellPos.r][cellPos.c] instanceof NormalTile) &&
        !this.uniqSuperTiles.has(cellPos)
      ) {
        this.activeteOtherSuperTiles(
          this.tiles[cellPos.r][cellPos.c].getAffected(this.tiles, cellPos),
          cellPos,
        );
      }
    });
